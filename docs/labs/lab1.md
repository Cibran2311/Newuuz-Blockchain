# Lab 1 — Wallet Setup and First Blockchain Transaction

## Introduction

Set up MetaMask, connect to Sepolia, receive test ETH, and send your first transaction.

## Before you start

Read or open:

- Ethereum docs, MetaMask, Sepolia Etherscan.
